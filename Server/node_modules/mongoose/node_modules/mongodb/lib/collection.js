...
/**
 * Execute the geoNear command to query for items in the collection
 *
 * @method   
 * @param {number} x Point to query on the x axis, ensure the indexes are ordered in the same order.
 * @param {number} y Point to query on the y axis, ensure the indexes are ordered in the same order.
 * @param {object} [options=null] Optional settings.
 * @param {(ReadPreference|string)} [options.readPreference=null] The preferred read preference (ReadPreference.PRIMARY, ReadPreference.PRIMARY_PREFERRED, ReadPreference.SECONDARY, ReadPreference.SECONDARY_PREFERRED, ReadPreference.NEAREST).
 ...
 * @param {boolean} [options.uniqueDocs=false] The closest location in a document to the center of the query region will always be returned MongoDB > 2.X.
...
/**
 * Execute a geo query using a geo haystack index on a collection.
 *
 * @method   
 * @param {number} x Point to query on the x axis, ensure the indexes are ordered in the same order.
 * @param {number} y Point to query on the y axis, ensure the indexes are ordered in the same order.
